            ...
            <div className="mx-36 pt-20">
                ...
                <div className="flex items-center justify-center mt-8">
                    <div className="relative flex bg-[#25262b] p-1 rounded-full w-72 h-10 shadow-lg">
                        <div
                            className={`absolute top-0 left-0 h-full w-1/2 bg-[#303136] rounded-full transition-all duration-300 ${
                        ...
                        {/* Yearly Button */}
                        <button
                            className={`relative flex-1 py-1 text-sm font-medium z-10 flex items-center justify-center transition-all duration-300 cursor-pointer ${
                        ...
                        >
                            Yearly
                            <span
                                className={`ml-2 bg-purple-500 text-[10px] text-white px-2 py-[2px] rounded-md shadow-md transition-opacity duration-300 ${
